...
class SixFiftyFiveHome extends StatefulWidget {
  const SixFiftyFiveHome({super.key});

  @override
  _SixFiftyFiveHomeState createState() => _SixFiftyFiveHomeState();
}

class _SixFiftyFiveHomeState extends State<SixFiftyFiveHome> {
  ...
  Future<void> _initializeDatabase() async {
    _database = await openDatabase(
      join(await getDatabasesPath(), 'lotto_results_655.db'),
      onCreate: (db, version) {
        return db.execute(
                          ...
                          onPressed: () {
                            ...
                            if (numbers.length == 6 &&
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                      'Enter 6 valid numbers between 1 and 55'),
                                ),
                              );
                            }
                          },
            ...
            FloatingActionButton(
              ...
              onPressed: () async {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SixFiftyFiveAnalysisPage(analysisResult: analysisResult),
                  ),
                );
              },
