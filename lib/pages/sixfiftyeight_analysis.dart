...
class SixFiftyEight extends StatefulWidget {
  const SixFiftyEight({super.key});

  @override
  _SixFiftyEightState createState() => _SixFiftyEightState();
}

class _SixFiftyEightState extends State<SixFiftyEight> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('6/58 Lotto Results'),
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: TextField(
                      ...
                      onChanged: _formatInput,
                      decoration: const InputDecoration(
                        hintText: 'Example: 01, 12, 23, 34, 41, 58',
                      ),
                    ),
                    actions: [
                      TextButton(
                        onPressed: () {
                          ...
                          if (numbers.length == 6 &&
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text(
                                    'Enter 6 valid numbers between 1 and 58'),
                              ),
                            );
                          }
                        },
