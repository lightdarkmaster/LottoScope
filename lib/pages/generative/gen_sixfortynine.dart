...
class SixFortyNineGenerator {
  final Random _random = Random();

  List<String> generateNumbers() {
    Set<int> numbers = {};
    while (numbers.length < 6) {
      int number = _random.nextInt(49) + 1;
      numbers.add(number);
    }
...
class SixFortyNinePage extends StatefulWidget {
  const SixFortyNinePage({super.key});

  @override
  _SixFortyNinePageState createState() => _SixFortyNinePageState();
}

class _SixFortyNinePageState extends State<SixFortyNinePage> {
  final SixFortyNineGenerator _generator = SixFortyNineGenerator();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lucky Pick 6/49'),
                  ...
                  child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            Image.asset(
                            'assets/icons/649.png', // Make sure to add your logo image in the assets folder and update the path accordingly
                            height: 100,
                          ),
                          ElevatedButton(
                            ...
                            child: const Text('Lucky Pick 6/49 Numbers', style: TextStyle(color: Colors.black),),
                          ),
